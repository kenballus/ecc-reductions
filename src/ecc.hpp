...
bool compute_edge_clique_cover(Graph const&, Cover&, size_t);
void extract_irreducible_subgraph(Graph const&, Cover&);
size_t size_of_big_vertex_independent_set(Graph const&, Cover&);
size_t size_of_big_edge_independent_set(Graph const&, Cover&);
